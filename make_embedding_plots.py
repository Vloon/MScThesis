...
det_params_func = bin_hyp_det_params if edge_type == 'bin' else con_hyp_det_params
...
for si, n_sub in enumerate(range(subject1, subjectn + 1)):
    for ti, task in enumerate(tasks):
        ...
        base_save_filename = f"{edge_type}_{geometry}_S{n_sub}_{task}_embedding{th_txt}{partial_txt}"
